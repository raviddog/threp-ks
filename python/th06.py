...
class Th06(KaitaiStruct):
    ...
    class Header(KaitaiStruct):
        ...
        def _read(self):
            ...
            if not self.magic == b"\x54\x36\x52\x50":
                raise kaitaistruct.ValidationNotEqualError(b"\x54\x36\x52\x50", self.magic, self._io, u"/types/header/seq/0")
